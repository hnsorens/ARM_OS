...
{
    /* --- Core Allocation --- */
    k_status_t (*alloc_page)(uint8_t page_order, paddr_t *out_frame);
    k_status_t (*free_page)(uint8_t page_order, paddr_t frame);
    ...
    k_status_t (*alloc_aligned)(size_t count, size_t alignment, paddr_t *out);
    ...
    k_status_t (*alloc_in_range)(size_t count, paddr_t max_addr, paddr_t *out);
    ...
    void (*retain)(paddr_t frame);
    void (*release)(paddr_t frame); // If count hits 0, it calls free_page()

    /* --- Statistics --- */
    size_t (*get_total_memory)(void);
    size_t (*get_free_memory)(void);
    k_status_t (*reserve_range)(paddr_t start, size_t sz);
