...
pub const SYS_statfs = shared.SYS_statfs;
pub const SYS_fstatfs = shared.SYS_fstatfs;
pub const SYS_mknodat = shared.SYS_mknodat;
...
pub const SYS_pselect6 = shared.SYS_pselect6;
...
pub const SYS_sigaltstack = shared.SYS_sigaltstack;
pub const SYS_rt_sigsuspend = shared.SYS_rt_sigsuspend;
pub const SYS_rt_sigaction = shared.SYS_rt_sigaction;
pub const SYS_rt_sigprocmask = shared.SYS_rt_sigprocmask;
pub const SYS_rt_sigpending = shared.SYS_rt_sigpending;
pub const SYS_rt_sigreturn = shared.SYS_rt_sigreturn;
...
pub const SYS_personality = shared.SYS_personality;
pub const SYS_getpriority = shared.SYS_getpriority;
pub const SYS_setpriority = shared.SYS_setpriority;
pub const SYS_sched_setscheduler = shared.SYS_sched_setscheduler;
pub const SYS_sched_getscheduler = shared.SYS_sched_getscheduler;
pub const SYS_sched_getparam = shared.SYS_sched_getparam;
pub const SYS_sched_get_priority_max = shared.SYS_sched_get_priority_max;
pub const SYS_sched_get_priority_min = shared.SYS_sched_get_priority_min;
pub const SYS_times = shared.SYS_times;
pub const SYS_getgroups = shared.SYS_getgroups;
pub const SYS_getrusage = shared.SYS_getrusage;
pub const SYS_getcpu = shared.SYS_getcpu;
pub const SYS_fadvise64 = shared.SYS_fadvise64;
pub const SYS_membarrier = shared.SYS_membarrier;
...
pub const UserReturnHook = shared.UserReturnHook;
pub const Signal = shared.Signal;
...
pub const O_CLOEXEC = shared.O_CLOEXEC;
...
pub const TIOCSCTTY = shared.TIOCSCTTY;
pub const FIONREAD = shared.FIONREAD;
pub const KTERMIOS_SIZE = shared.KTERMIOS_SIZE;
pub const ISIG = shared.ISIG;
pub const ICANON = shared.ICANON;
pub const ECHO = shared.ECHO;
pub const POLLIN = shared.POLLIN;
pub const POLLPRI = shared.POLLPRI;
pub const POLLOUT = shared.POLLOUT;
pub const POLLERR = shared.POLLERR;
pub const POLLHUP = shared.POLLHUP;
pub const POLLNVAL = shared.POLLNVAL;
...
pub const ERESTARTSYS = shared.ERESTARTSYS;
