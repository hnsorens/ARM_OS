...
pub fn importSection(comptime type_name: []const u8, comptime instance_name: []const u8) []const u8 {
    return IMPORT_SECTION_PREFIX ++ type_name ++ "." ++ instance_name;
}

pub fn importSectionAny(comptime type_name: []const u8) []const u8 {
