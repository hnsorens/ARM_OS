...
#define kmm_kmalloc CONCAT(KMM_NAME, _kmalloc_func)
#define kmm_kmalloc_aligned CONCAT(KMM_NAME, _kmalloc_aligned_func)
#define kmm_kcalloc CONCAT(KMM_NAME, _kcalloc_func)
#define kmm_krealloc CONCAT(KMM_NAME, _krealloc_func)
#define kmm_kfree CONCAT(KMM_NAME, _kfree_func)
#define kmm_ksalloc CONCAT(KMM_NAME, _ksalloc_func)
#define kmm_ksfree CONCAT(KMM_NAME, _ksfree_func)
  ...
  /** 
    ...
    * 
    */ 
extern void* kmm_kmalloc( unsigned long size );
  ...
  /** 
    ...
    * 
    */ 
extern void* kmm_kmalloc_aligned( unsigned long size, unsigned long align );
  ...
  /** 
    ...
    * 
    */ 
extern void* kmm_kcalloc( unsigned long count, unsigned long size );
  ...
  /** 
    ...
    */ 
extern void* kmm_krealloc( void* ptr, unsigned long size );
  ...
  /** 
     ...
     * 
     */ 
extern void kmm_kfree( void* ptr );
   ...
   */ 
extern void* kmm_ksalloc( int order );
   ...
   */ 
extern void kmm_ksfree( int order, void* addr );
#endif