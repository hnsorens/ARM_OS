...
#define str_memset CONCAT(STR_NAME, _memset_func)
#define str_memcpy CONCAT(STR_NAME, _memcpy_func)
#define str_memmove CONCAT(STR_NAME, _memmove_func)
#define str_memcmp CONCAT(STR_NAME, _memcmp_func)
#define str_memchr CONCAT(STR_NAME, _memchr_func)
#define str_strlen CONCAT(STR_NAME, _strlen_func)
#define str_strcpy CONCAT(STR_NAME, _strcpy_func)
#define str_strncpy CONCAT(STR_NAME, _strncpy_func)
#define str_strcat CONCAT(STR_NAME, _strcat_func)
#define str_strncat CONCAT(STR_NAME, _strncat_func)
#define str_strcmp CONCAT(STR_NAME, _strcmp_func)
#define str_strncmp CONCAT(STR_NAME, _strncmp_func)
#define str_strchr CONCAT(STR_NAME, _strchr_func)
#define str_strrchr CONCAT(STR_NAME, _strrchr_func)
#define str_strstr CONCAT(STR_NAME, _strstr_func)
#define str_strdup CONCAT(STR_NAME, _strdup_func)
  ...
  /** 
    ...
    * 
    */ 
extern void* str_memset( void* s, int c, unsigned long n );
  ...
  /** 
    ...
    * 
    */ 
extern void* str_memcpy( void* dest, const void* src, unsigned long n );
  ...
  /** 
    ...
    * 
    */ 
extern void* str_memmove( void* dest, const void* src, unsigned long n );
  ...
  /** 
    ...
    * 
    */ 
extern int str_memcmp( const void* s1, const void* s2, unsigned long n );
  ...
  /** 
    ...
    * 
    */ 
extern void* str_memchr( const void* s, int c, unsigned long n );
  ...
  /** 
    ...
    * 
    */ 
extern unsigned long str_strlen( const char* s );
  ...
  /** 
    ...
    * 
    */ 
extern char* str_strcpy( char* dest, const char* src );
  ...
  /** 
    ...
    * 
    */ 
extern char* str_strncpy( char* dest, const char* src, unsigned long n );
  ...
  /** 
    ...
    * 
    */ 
extern char* str_strcat( char* dest, const char* src );
  ...
  /** 
    ...
    * 
    */ 
extern char* str_strncat( char* dest, const char* src, unsigned long n );
...
extern int str_strcmp( const char* s1, const char* s2 );
  ...
  /** 
    ...
    * 
    */ 
extern int str_strncmp( const char* s1, const char* s2, unsigned long n );
  ...
  /** 
    ...
    * 
    */ 
extern char* str_strchr( const char* s, int c );
  ...
  /** 
    ...
    * 
    */ 
extern char* str_strrchr( const char* s, int c );
  ...
  /** 
    ...
    * 
    */ 
extern char* str_strstr( const char* haystack, const char* needle );
