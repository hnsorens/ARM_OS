...
#define pmm_alloc_virt_kernel CONCAT(PMM_NAME, _alloc_virt_kernel_func)
#define pmm_free_virt_kernel CONCAT(PMM_NAME, _free_virt_kernel_func)
#define pmm_alloc_phys CONCAT(PMM_NAME, _alloc_phys_func)
#define pmm_free_phys CONCAT(PMM_NAME, _free_phys_func)
#define pmm_memory_available CONCAT(PMM_NAME, _memory_available_func)
  ...
  /** 
    ...
    * 
    */ 
extern void* pmm_alloc_virt_kernel( void* vaddr, unsigned long size );
  ...
  /** 
    ...
    * 
    */ 
extern void pmm_free_virt_kernel( void* vaddr, unsigned long size );
  ...
  /** 
    ...
    * 
    */ 
extern void* pmm_alloc_phys( unsigned long order );
  ...
  /** 
    ...
    * 
    */ 
extern void pmm_free_phys( void* paddr, unsigned long order );
  ...
  /** 
     ...
     * 
     */ 
extern unsigned long pmm_memory_available( void );
#endif